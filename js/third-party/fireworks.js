...
if (canvasEl) {
    var ctx = canvasEl.getContext('2d'), numberOfParticules = 30, pointerX = 0, pointerY = 0, tap = 'mousedown', colors = ["#FF1461","#18FF92","#5A87FF","#FBF38C"], setCanvasSize = btf.debounce(function () {
